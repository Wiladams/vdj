...
namespace glib
{
    ...
    struct rgba8T
    {
        ...
        //--------------------------------------------------------------------
        static INLINE double to_double(value_type a)
        {
            return double(a) / base_mask;
        }

        //--------------------------------------------------------------------
        static INLINE value_type from_double(double a)
        {
            return value_type(uround(a * base_mask));
        }

        //--------------------------------------------------------------------
        static INLINE value_type empty_value()
        {
            return 0;
        }

        //--------------------------------------------------------------------
        static INLINE value_type full_value()
        {
            return base_mask;
        }
        ...
        //--------------------------------------------------------------------
        static INLINE value_type invert(value_type x)
        {
            return base_mask - x;
        }

        //--------------------------------------------------------------------
        // Fixed-point multiply, exact over uint8_t.
        static INLINE value_type multiply(value_type a, value_type b)
        {
        ...
        //--------------------------------------------------------------------
        static INLINE value_type demultiply(value_type a, value_type b)
        {
            if (a * b == 0)
            {
                return 0;
        ...
        //--------------------------------------------------------------------
        template<typename T>
        static INLINE T downshift(T a, unsigned n)
        {
            return a >> n;
        }
        ...
        static INLINE value_type mult_cover(value_type a, cover_type b)
        {
            return multiply(a, b);
        }

        //--------------------------------------------------------------------
        static INLINE cover_type scale_cover(cover_type a, value_type b)
        {
            return multiply(b, a);
        }
        ...
        static INLINE value_type prelerp(value_type p, value_type q, value_type a)
        {
        ...
        static INLINE value_type lerp(value_type p, value_type q, value_type a)
        {
        ...
        //--------------------------------------------------------------------
        INLINE self_type& premultiply(unsigned a_)
        {
    ...
    struct rgba16
    {
        ...
        //--------------------------------------------------------------------
        // Fixed-point multiply, exact over uint16_t.
        static INLINE value_type multiply(value_type a, value_type b)
        {
            calc_type t = a * b + base_MSB;
            return value_type(((t >> base_shift) + t) >> base_shift);
        ...
        //--------------------------------------------------------------------
        // Fixed-point multiply, almost exact over uint16_t.
        // Specifically for multiplying a color component by a cover.
        static INLINE value_type mult_cover(value_type a, cover_type b)
        {
        ...
        //--------------------------------------------------------------------
        INLINE self_type& opacity(double a_)
        {
            if (a_ < 0) a = 0;
            if (a_ > 1) a = 1;
